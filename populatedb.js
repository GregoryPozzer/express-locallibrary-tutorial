...
async function createAuthors() {
  ...
  await Promise.all([
    ...
    authorCreate(5, "Gregory", "Pozzer", false, false),
  ]);
}
...
async function createBooks() {
  ...
  await Promise.all([
    ...
    bookCreate(
      ...
      "Um guia introdutório sobre os princípios básicos do desenvolvimento web, incluindo HTML, CSS e JavaScript.",
      "ISBN333333",
      authors[5],
      [genres[1]]
    ),
...
async function createBookInstances() {
  ...
  await Promise.all([
    ...
    bookInstanceCreate(11, books[7], "Editora Exemplo, 2023.", false, "Available"),
  ]);
}
